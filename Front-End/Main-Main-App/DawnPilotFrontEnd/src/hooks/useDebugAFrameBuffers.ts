 ...
 */
export const useDebugAFrameBuffers = (
  options?: {
    enabled?: boolean;
    logInterval?: number;
 ...
 */
export const useDebugAFrameBuffersWithSelector = (
 ...
 */
export const useDebugAFrameBuffersDev = (
  options?: {
    logInterval?: number;
    logPixelData?: boolean;
  }
...
import { useDebugAFrameBuffers } from './useDebugAFrameBuffers';
...
import { useDebugAFrameBuffersDev } from './useDebugAFrameBuffers';
...
import { useDebugAFrameBuffersWithSelector } from './useDebugAFrameBuffers';

function BuilderPage() {
  useDebugAFrameBuffersWithSelector('#my-scene', {
    enabled: true
  });
